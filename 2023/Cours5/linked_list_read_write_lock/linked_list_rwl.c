 ...
 * 
 * Compile:  gcc -g -Wall -o linked_list_rwl linked_list_rwl.c
 *              my_rand.c -lpthread
 *           needs timer.h and my_rand.h
 * Usage:    ./linked_list_rwl <thread_count>
 ...
 *
 * From Introduction to Parallel Programming:   Section 4.9.3 (pp. 187 and ff.)
 */
#include <stdio.h>
#include <stdlib.h>
#include <pthread.h>
